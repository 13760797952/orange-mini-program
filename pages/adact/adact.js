...
Page({
    ...
    setActContent: function() {
        ...
        wx.request({
            url: app.siteInfo.siteroot + "?i=" + app.siteInfo.uniacid + "&c=entry&a=wxapp&do=smk_adact_one&m=" + app.moduleName,
            data: {
                aid: a
            },
            success: function(a) {
                console.log(a), t.setData({
                    ...
                    barTitle: a.data.data.one.name
                }), wx.setNavigationBarTitle({
                    title: a.data.data.one.name
